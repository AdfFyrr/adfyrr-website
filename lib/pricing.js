...
const COUPONS = {
  ...
  // ---------------------------------------------------------------------
  // TEST ONLY — ₹29, for running a real end-to-end payment cheaply.
  // This repository is PUBLIC, so this code is readable on GitHub and the
  // name is easy to guess. DELETE THIS LINE before sending any ad traffic,
  // or strangers can buy the playbook for ₹29.
  // ---------------------------------------------------------------------
  TEST29: { amount: 2900, off: 27000, label: '0 → 1300 Orders Playbook (internal test)' }
};
